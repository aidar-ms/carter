...
def setup_periodic_tasks(sender, **kwargs):
    ...
    sender.add_periodic_task(
        crontab(minute="0", hour="*/6"), parse_blog.s("https://engineering.atspotify.com/"), name='Parse Spotify'
    )
    # Task to parse Google
    sender.add_periodic_task(
        crontab(minute="0", hour="*/6"), parse_blog.s("https://developers.googleblog.com/"), name='Parse Google'
    )
